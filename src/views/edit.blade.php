...
<div class="row no-gutters">
    ...
    <div class="col-sm py-2 text-white">
                ...
                <input type="text" name="name" class="form-control bg-dark text-white" placeholder="Company" value="{{ $c->company}}" required>
                </div>
...
<div class="row no-gutters">
    <div class="col-sm py-2 text-white">
                ...
                <span class="badge badge-pill bg-danger">&nbsp;</span>
                 @endif
                <input type="text" name="address" class="form-control bg-dark text-white" placeholder="Address" value="{{ $c->address}}">
                </div>
                <div class="form-group">
                @if ($c->town == '')
                <span class="badge badge-pill bg-danger">&nbsp;</span>
                @endif
                <input type="text" name="town" class="form-control bg-dark text-white" placeholder="Town" value="{{ $c->town}}">
                </div>
                <div class="form-group">
                @if ($c->county == '')
                <span class="badge badge-pill bg-danger">&nbsp;</span>
                @endif
                <input type="text" name="county" class="form-control bg-dark text-white" placeholder="County" value="{{ $c->county}}">
                </div>
                <div class="form-group">
                @if ($c->postcode == '')
                <span class="badge badge-pill bg-danger">&nbsp;</span>
                @endif
                <input type="text" name="postcode" class="form-control bg-dark text-white" placeholder="Postcode" value="{{ $c->postcode}}">
                </div>
                <div class="form-group">
                @if ($c->country == '')
                <span class="badge badge-pill bg-danger">&nbsp;</span>
                @endif
                <input type="text" name="country" class="form-control bg-dark text-white" placeholder="Country" value="{{ $c->country}}">
                </div>
...
<div class="row no-gutters">
    ...
    <div class="col-sm py-2 text-white">
                ...
                <div class="form-group">
                <input type="text" name="tax_no" class="form-control bg-dark text-white" placeholder="Tax ID" value="{{ $c->vat_no}}" >
                </div>
...
<div class="row no-gutters">
    <div class="col-sm py-2 text-white">
                ...
                <span class="badge badge-pill bg-danger">&nbsp;</span>
                 @endif
                <select  name="status" class="form-control bg-dark text-white" ><option>{{ $c->status}}</option>
                <option>--------</option>
